...
<script type="text/javascript"
	src="<c:url value='/scripts/frame/client/merchantAndPeasant/processing_list.js'/>"></script>
<linkage:define />
</head>
<body contextpath="<%=request.getContextPath()%>">
	<div class="ui-tabs ui-widget ui-widget-content ui-corner-all"
		...
		<ul
			...
			<li class="ui-state-default ui-corner-top"><a href="#div-2">生成企业存货</a></li>
			<li class="ui-state-default ui-corner-top"><a href="#div-2">生产成本和毛利率核算</a></li>
				<li class="ui-state-default ui-corner-top"><a href="#div-2">资产负债表</a></li>
			<li class="ui-state-default ui-corner-top"><a href="#div-2">销售与采购计算</a></li>
			<li class="ui-state-default ui-corner-top"><a href="#div-2">经营和家庭现金流</a></li>
