...
<script type="text/javascript"
	src="<c:url value='/scripts/frame/client/merchantAndPeasant/livestock.js'/>"></script>
...
<body contextpath="<%=request.getContextPath()%>">
	<Table style="width: 100%">
		<tr>
			<td style="width: 50%" valign="top">
				...
				<div id="saveproductDiv" loxiaType="edittable">
				...
				<div id="fixacccountDiv" loxiaType="edittable">
					<table operation="add,delete" append="1" width="100%" id="fixacccountTable">
						<thead>
							<tr>
								<th><input type="checkbox" name="selectCostAll"
									id="selectCostAll" /></th>
			...
			<td style="width: 50%" valign="top">
				...
				<div id="yearincomeDiv" loxiaType="edittable">
					<table operation="add,delete" append="1" width="100%"
						id="yearincomeTable">
						<thead>
							<tr>
		...
		<br />
		<div id="payoutDiv" loxiaType="edittable">
			<table operation="add,delete" append="1" width="100%"
				id="payoutTable">
				<thead>
					<tr>
				...
				<tbody>
					<tr>
						...
						<td><input type="text" loxiaType="input" name="ctype"
							value="" mandatory="true" /></td>
						<td><input type="text" loxiaType="input" name="payOut"
	...
	<table  id="table" operation="add,delete" 
					style="width: 100%;">
			<thead>
				<tr>
				    <th><input type="checkbox" name="selectCostAll"
