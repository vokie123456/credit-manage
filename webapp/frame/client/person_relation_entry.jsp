...
<script type="text/javascript"
	src="<c:url value='/scripts/frame/client/person_relation_entry.js'/>"></script>
				...
				<table class="col3">
					...
					<tr>
						...
						<td class="content"><bizoption:bizoption biztypekey="1007"
								id="cardType" selected="${personRelation.cardType }"
								name="resonRelations[${loop.index}].cardType" isChoose="false"
						...
						<td class="content"><input id="cardNo" loxiaType="input"
							...
							value="${personRelation.cardCode}" checkmaster="validateIdentify" /><label
							class="del_mandatory">&nbsp;&nbsp;</label></td>
					</tr>
					<tr>
						<td class="label"><fmt:message
						...
						<td class="content"><input id="mobilePhone" loxiaType="input"
							trim="true" name="resonRelations[${loop.index}].mobilePhone"
					...
					<tr>
						...
						<td align="left"><input id="incomeWorkunit"
							loxiaType="number"
							name="resonRelations[${loop.index}].incomeWorkunit" decimal="2"
