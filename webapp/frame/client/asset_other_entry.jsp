...
<script type="text/javascript"
	src="<c:url value='/scripts/frame/client/asset_other_entry.js'/>"></script>
</head>
			...
			<table class="col3">
				<tr>
					...
					<td class="content"><bizoptionname:showname biztypekey="1097"
							name="assetBasic.assetType" value="${assetBasic.assetType }" />
						<input type="hidden" name="assetBasic.assetType"
					...
					<table class="col3">
						...
						<tr>
							...
							<td class="content"><input
								...
								value="${compAssetRelation.legalCardNo}" checkmaster="validateCardNo"/></td>
						</tr>
						<tr>
							<!-- 企业性质 -->
							<td class="label"><fmt:message
