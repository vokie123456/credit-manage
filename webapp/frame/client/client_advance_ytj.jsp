...
<script type="text/javascript"
	src="<c:url value='/scripts/frame/client/client_advance_ytj.js?v=3.5'/>"></script>
<style type="text/css">
.label {
	text-align: right;
}
		...
		<!-- 	<button type="button" loxiaType="button" class="confirm" id="batchAllocation" />
			...
			<table>
				<tr>
					...
					<td><input class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only ui-state-hover" type="button" value="已推进" id="alreadyAdvance"/></td>
