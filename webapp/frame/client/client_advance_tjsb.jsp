...
<script type="text/javascript"
	src="<c:url value='/scripts/frame/client/client_advance_tjsb.js?v=3.5'/>"></script>
<style type="text/css">
.label {
	text-align: right;
}
	...
	<form id="lendListForm" method="post">
		<table>
			...
			<tr>
				...
				<td class="timeDv"><input name="wrokProvince"
					loxiaType="input" trim="true" placeholder="省"/>
					<input name="workCity"
						   loxiaType="input" trim="true" placeholder="市"/>
				</td>
				<td class="label"> 房产所在地：</td>
				<td class="timeDv"><input id="" name="housePropertyProvince"
					loxiaType="input" trim="true"  placeholder="省"/>
					<input id="" name="housePropertyCity"
						   loxiaType="input" trim="true" placeholder="市"/>
				</td>
			</tr>
		...
		<div class="buttonlist buttonDivWidth">
			...
			<table>
				<tr>
					...
					<td><input class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only ui-state-hover" type="button" value="推进失败" id="promoteFail"/></td>
				</tr>
			</table>
