...
<script type="text/javascript"
	src="<c:url value='/scripts/frame/base/menu_list_action.js'/>"></script>
...
<body contextpath="<%=request.getContextPath()%>">
	<div class="middle">
		<div class="width300 floatleft paddingLeft200">
			<textarea id="menuList" rows="3" cols="100"
				class="disNone">${menuList }</textarea>
		...
		<div id="dlg" class="easyui-dialog" modal="true">
			<iframe scrolling="auto" id='openMenuIFrame' frameborder="0"  src="" style="width:100%;height:100%;"></iframe>
		</div>
	</div>
</body>
</html>