...
<script type="text/javascript" src="<c:url value='/scripts/frame/base/dayoff/dayoff_add.js'/>"></script>
<div class="fancy">
	<h3>编辑事件</h3>
	<form id="add_form" method="post">
		...
		<p>
			开始时间：<input type="text" class="input " name="dayOff"
				id="dayOff"  value="${date }" readonly="readonly"> <span
				id="sel_start"  class="disNone"><select name="s_hour">
		...
		<p id="p_endtime" style="display: none;">
			结束时间：<input type="text" class="input datepicker" name="endDate"
				id="endDate"  readonly> <span id="sel_end"
