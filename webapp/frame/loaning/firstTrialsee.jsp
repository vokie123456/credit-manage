...
<script type="text/javascript" src="<c:url value='/scripts/newsZr/htmlLoadsee.js?v=1.0.3'/>"></script>
	...
	<div class="ui-tabs-panel ui-corner-bottom ui-helper-clearfix bor-zr" id="div-1">
		<div class="use-detail-left">
			<div class="tab-btn-dv clearFix" style="width: 252px; float: left;">
				<a onclick="pageJump(this)" data-type="collection" data-lendApplyId="${lendApplyId}" href="javascript:;">催收记录</a>
				<a class="active" href="javascript:;">授信详情</a>
			</div>
