...
<head>
    ...
    <script type="text/javascript"
            src="<c:url value='/scripts/frame/loaning/ExchangeOfFunds.js?v=1.5'/><c:out value='${now.getTime()}'/>"></script>
    <script type="text/javascript"
...
<form id="lendListForm" method="post">
    <table>
        ...
        <tr>
            ...
            <td width="150">
                <bizselect:bizselect biztypekey="1250" startSort="1" endSort="5" name="checkStatus" id="id_checkStatus" isChoose="true" />
