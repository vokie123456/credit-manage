...
<body contextpath="<%=request.getContextPath()%>">
	<form id="qryfrm" action="/loanpost/advance/downexcel.do" method="POST">
		<table>
			<tr>
				...
				<td>
					...
					<input type="hidden" name="advanceStatusGt" value="191702,191703" />
				</td>
				...
				<td class="seleTd">
					<select name="advanceStatus">
						...
						<option value="191702">垫资中</option>
		...
		<div class="buttonlist buttonDivWidth">
			<button type="button" loxiaType="button" class="confirm" id="btnadvanceQr">确认垫资</button>
