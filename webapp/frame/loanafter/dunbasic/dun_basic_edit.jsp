...
<script type="text/javascript"
	src="<c:url value='/scripts/frame/loanafter/dunbasic/dun_basic_edit.js'/>"></script>
</head>
<style>
	.content ul{
	padding: 0px; 
		...
		target="temp" >
			<table class="col3">
				...
				<tr>
					...
					<td class="content"><input type="hidden" id="dunWho"
						name="dunWho" value="${userId }" />${userName }</td>
