...
<head>
    ...
    <script type="text/javascript"
            src="<c:url value='/scripts/frame/workflow/taskList/workflow_task.js?v='/><c:out value='${now.getTime()}'/>"></script>
    <script type="text/javascript"
        ...
        <form id="taskCommandForm" method="post">
            <table>
                ...
                <tr>
                    ...
                    <td class="width200"><input id="" name="getTimeBegin"
                                                loxiaType="date" trim="true" style="width: 43%"/>-<input id=""
                                                                                                         name="getTimeEnd"
                                                                                                         loxiaType="date"
                                                                                                         trim="true"
                                                                                                         style="width: 43%"/>
                    ...
                    <td class="width200"><input id="" name="createTimeBegin"
                                                loxiaType="date" trim="true" style="width: 43%"/>-<input id=""
                                                                                                         name="createTimeEnd"
                                                                                                         loxiaType="date"
                                                                                                         trim="true"
            ...
            <div class="buttonlist buttonDivWidth">
                ...
                <button type="button" id="caseCancel" loxiaType="button" class="confirm" title="tip"/>
                领取案件
                </button>
                &nbsp;&nbsp;&nbsp;&nbsp;<span class="content">当前有待处理案件<span class="dealwith"></span>个,还可以领取<span
                    class="get"></span>个</span>
            </div>
