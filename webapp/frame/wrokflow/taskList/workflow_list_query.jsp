...
<head>
    ...
    <script type="text/javascript"
            src="<c:url value='/scripts/frame/workflow/taskList/workflow_list_query.js?v=3.1.4'/>"></script>
    <script type="text/javascript"
            ...
            <table>
                <tr>
                    ...
                    <td class="width200"><bizselect:bizselect biztypekey="1187"
                                                              id="taskList_ifOver" name="taskIfOver"
                                                              isChoose="true"/></td>
                    ...
                    <td class="width200"><input id="final_money_b" name="final_money_b"
                                                loxiaType="number" trim="true" style="width: 43%"/>-<input
                            id="final_money_e" name="final_money_e"
                ...
                <tr>
                    ...
                    <td class="width200"><input id="taskPerson" name="taskPerson"
                                                loxiaType="input" trim="true"/></td>
                ...
                <tr>
                    ...
                    <td width="150">
                        <select id="applicationProductMaxId" name="applicationProductMaxId">
                            <option value="">请选择</option>
                        </select>
                    </td>
