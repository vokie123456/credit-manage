...
<div class="file-left">
    ...
    <div class="file-img-dv" data-type="sfz">
        <div id="sfz-dv">
            ...
            <div class="dv-img" id="shenfenupload"></div>
        </div>
    </div>
    <div id="fczl_dv" data-type="fczl">

    </div>
    <div class="tit-after" id="jkyt">
		<span>
			借款用途证明材料
		</span>
    </div>
    <div class="file-img-dv" data-type="jkyt">
        ...
        <div class="dv-img" id="jiekuanyongtu">

        </div>
    </div>

    <!-- <div class="tit-after" id="fcxx_dv" >
        <span>
            房产资料
        </span>
        <a data-type="carId" class="remark-click-find">查看</a>
        <a data-type="sfz" class="remark-click">备注</a>
    </div>
    <div id="fczl_dv" data-type="fczl">
...
<div class="sczl-right">
    ...
    <div class="cllx">
        ...
        <select name="imageType" id="imageType">
            ...
            <option value="1200">身份证信息</option>
            <option value="119809">房产资料</option>
            <option value="1265">工作证明</option>
            <option value="1264">营业执照资料</option>
            <option value="1263">征信报告</option>
            <option value="1266">借款用途</option>
            <option value="119999">其他</option>
        </select>
    </div>
    <div>
        <button id="hkBtn" class="button">文件选择</button>
    </div>
    <div class="imgContent">

    </div>
    <div class="fileBtn">
        <button class="button upload" id="uploadImg">上传</button>
        <button class="button" id="btnCancel">取消</button>
    </div>
</div>
<form action="<%=request.getContextPath() %>/base/api/upload.do" id="uploadForm" method="post"
      enctype="multipart/form-data" style="display:none;">
    <input id="myFile" type="file" name="file" multiple/>
</form>
            ...
            <table class="fcxx-table">
                ...
                <tr>
                    ...
                    <td colspan="3" class="dreassDv">
                        <linkage:select type="province" name="provinceId" pid="pb1" cid="cb1" did="db1"
                                        seledProvince="${per.address1.province}"/>
                        <linkage:select type="city" seledCity="${per.address1.city}" name="cityId" cid="cb1" did="db1"/>
                        <linkage:select type="district" seledDistrict="${per.address1.district}" name="districtId"
                                        did="db1"/>
                ...
                <tr>
                    ...
                    <td>
                        <input name="buildYear" class="Wdate" onblur="WdateFocus(this)"
                               onfocus="WdatePicker({skin:'default',dateFmt:'yyyy'});" type="text"/>
                    </td>
                    <td>
                        <label>房龄：</label>
                    </td>
                    <td>
                        <input name="that" readonly="readonly" style="cursor: not-allowed; background-color:#ccc;"
                               type="text"/>
                    </td>
                </tr>
                <tr>
...
<script type="text/javascript" src="<c:url value='/scripts/newsZr/sczl2.js?v=2.1.7'/>"></script>