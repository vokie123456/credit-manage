...
<script type="text/javascript" src="<c:url value='/scripts/newsZr/htmlLoad.js?v=2.1.2'/>"></script>
				...
				<tbody>
					...
					<tr>
						<td>
							...
							<span id="userContent1_2"></span>
							<a id="userContent1_3" style="color: #009900; float: right;margin-right: 20px; text-decoration: none;" href="javascript:;">点击认证</a>
						</td>
					...
					<tr>
						<td>
							...
							<a class="point-color">此号码在<span id="userContent5">30</span>台手机上使用过</a>
					...
					<tr>
						<td>
							...
							<a data-title="通话记录" data-type="thjl" class="point-color detail-lf-a">查看通话记录</a>
						</td>
						<td class="w85 typeText"></td>
						<td class="w85">
					...
					<tr>
						<td>
							...
							<a class="point-color detail-lf-a" data-title="登录时间及IP" data-type="dlsj_IP">查看登录记录及IP记录</a>
						</td>
						<td class="w85 typeText"></td>
						<td class="w85">
					...
					<tr>
						<td>
							...
							<a class="point-color detail-lf-a" data-title="登录时间及IP" data-type="dlsj_IP"> 查看详细IP记录</a>
						</td>
						<td class="w85 typeText"></td>
						<td class="w85">
			...
			<table id="work_dv" class="table-text-left tabcustomPeo left-user-table" cellpadding="0" cellspacing="0">
				<tbody>
					...
					<tr>
						<td>
							<sup class="sup-color">*</sup>
							<span class="td-text">月均收入：<span id="information8"></span>元</span>
						</td>
						<td class="w85 typeText"></td>
						<td class="w85">
				...
				<tbody>
					...
					<tr>
						<td>
							...
							<a id="hyrStatusBtn" style="color: #009900; margin-right: 20px; text-decoration: none;" href="javascript:;">点击获取</a>
							<label id="hyrStatus"></label>
						</td>
						<td class="w85 typeText" id="hmd_status"></td>
						<td class="w85">
					...
					<tr>
					   <td>
							...
							<a id="mGBtn" style="color: #009900; margin-right: 20px; text-decoration: none;" href="javascript:;">点击获取</a>
						</td>
		...
		<div class="use-file-right">
			<nav>
				<ul class="nav-file-zr" id="nav-li-a">
					...
					<li>
						<c:choose>
							<c:when test="${page_type=='1' }">
								<a href="#nav-dv-3">初审</a>
							</c:when>
							<c:otherwise>
								<a href="#nav-dv-3">终审</a>
							</c:otherwise>
						</c:choose>
					</li>
					<li>
			...
			<div id="nav-content-dv">
				<div class="nav-dv" id="nav-dv-1" style="min-height: 1308px;">
					<div class="tab-dv-a" id="detail-ri-tab">
						<a class="point-color" data-type="sczl" data-title="上传资料">客户上传资料</a>
				...
				<div class="nav-dv" id="nav-dv-2">
					<div class="dv-table">
						<form id="verification_Frm">
							<table class="cs-table" style="width:100%;">
								<tbody>
									<tr>
										<td class="w85">电话号码：</td>
										<td>
											<select name="telephone">
												...
												<option value="三方号码">三方号码</option>
											</select>
										</td>
									</tr>
									<tr>
										<td valign="top" class="w85" style="padding-top:20px;">调查备注：</td>
										<td style="padding-top:20px;">
											<textarea id="editor_id" name="auditorDetail" style="width:530px; height: 100px; resize: none; padding: 5px; box-sizing: border-box;"></textarea>
										</td>
									</tr>
									<tr class="phoneBtnTr">
										<td></td>
										<td>
											...
											<button id="verification_Btn" type="button">保存</button>
										</td>
									</tr>
								</tbody>
							</table>
						...
						<table id="telephone_survey_list" class="def-table cs-table" cellpadding="0" cellspacing="0" style="width:630px;">
							<thead>
								<tr class="BgColor">
									...
									<!-- <td style="width:40px;"><strong>操作</strong></td> -->
								</tr>
							</thead>
							<tbody>
								<tr>
									...
									<td></td>
									<td>
										<a class="point-color" href="javascript:;">删除</a>
									</td>
								</tr>
								<tr>
									<td>林海</td>
				...
				<%
					if(request.getAttribute("page_type").equals("1")){
				%>
					<%@include file="/frame/business/html/first.jsp" %>
				<%
					}else{
				%>
					<%@include file="/frame/business/html/last.jsp" %>
				<%
					}
				%>
				</div>
