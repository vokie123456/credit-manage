	...
	<Table style="width: 100%" >
		<tr>
			<td style="width: 50%" valign="top">
				<table class="col3" cellpadding="0" cellspacing="0"
					...
					<tr>
						...
						<td class="content right"><input  name="money"
							loxiaType="input" trim="true" loxiaType="number" 
							sumTextId="summoney"
					...
					<table operation="add,delete" append="1" width="100%" id="bidMoneyTable">
						...
						<tbody>
							<tr>
								...
								<td><input type="text" loxiaType="input" name="remark"
									value="" /></td>
								<td><input type="text" loxiaType="input" name="badmoney"
				...
				<table class="col3" cellpadding="0" cellspacing="0"
						...
						<tr>
							...
							<td class="content right"><input  name="money"
								loxiaType="input" trim="true" loxiaType="number"/></td>
						</tr>
						<tr>
							<td class="label bottom bottomleft">总资产：</td>
							<td class="content bottomright bottom right"><input name="money"
								loxiaType="input" trim="true" loxiaType="number"/></td>
						</tr>
					</table>
				<br/>
				...
				<div class="content_middle">
					<table class="col3">
						<tr>
							<td><textarea style="width: 100%; min-height: 150px;"></textarea></td>
						</tr>
					</table>
				</div>
			...
			<td style="width: 50%" valign="top">
				...
				<div class="divBgColor">家庭现金流</div>
				<div id="gradeDiv" loxiaType="edittable">
