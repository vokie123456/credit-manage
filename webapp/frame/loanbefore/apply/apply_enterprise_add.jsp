...
<script type="text/javascript"
	src="<c:url value='/scripts/frame/loanbefore/apply/apply_enterprise_add.js'/>"></script>
<script type="text/javascript"
	...
	<div class="ui-tabs ui-widget ui-widget-content ui-corner-all"
		...
		<div class="ui-tabs-panel ui-widget-content ui-corner-bottom"
			...
			<form id="applyAddForm" method="post">
				...
				<!--
			<input type="hidden" id="applyId" name="applyBasic.applyId" />
			-->
				...
				<table>
					...
					<tr>
						...
						<td class="content"><input id="loanHopeMoney"
							value="${enterpriseBasic.loanHopeMoney}" loxiaType="number"
							decimal="2" max="9999999.99" trim="true" mandatory="true"
							name="applyBasic.loanHopeMoney" /> <label class="del_mandatory">&nbsp;&nbsp;*</label></td>
					</tr>
					<tr>
						<!-- 贷款用途  键值对数据 -->
						<td class="label"><fmt:message
						...
						<td class="content"><radio:radio biztypekey="1099"
								id="loanPurpose" name="applyBasic.loanPurpose"></radio:radio><label
							class="del_mandatory">&nbsp;&nbsp;*</label></td>
					</tr>
					<tr>
						...
						<td class="content"><radio:radio biztypekey="1022"
								id="infoFrom" name="applyBasic.infoFrom"></radio:radio><label
							class="del_mandatory">&nbsp;&nbsp;*</label></td>
					</tr>
					...
					<div id="formApplyAdd">
						...
						<table class="col3">
							...
							<tr>
								...
								<td colspan="3"><input id="scopeMajor" style="width: 94%;"
									loxiaType="input" name="enterpriseBasic.scopeMajor" trim="true"
									value="${enterpriseBasic.scopeMajor}" /></td>
							</tr>
							<tr>
								<td class="label">经营范围/兼营：</td>
								<td colspan="3"><input id="scopeMiner" style="width: 94%;"
									loxiaType="input" name="enterpriseBasic.scopeMiner" trim="true"
					...
					<table class="col3">
						...
						<tr>
							...
							<td class="content"><userDepartment:userDepartment
									...
									selected="${enterpriseBasic.saleraCode}"
							...
							<td class="content"><userDepartment:userDepartment
									...
									selected="${enterpriseBasic.salerbCode}"
