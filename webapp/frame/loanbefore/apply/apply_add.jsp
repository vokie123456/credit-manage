...
<script type="text/javascript"
	src="<c:url value='/scripts/frame/loanbefore/apply/apply_add.js'/>"></script>
<script type="text/javascript"
		...
		<div class="ui-tabs-panel ui-widget-content ui-corner-bottom"
			...
			<form id="applyAddForm" method="post">
				<input type="hidden" id="projectStauts"
					...
					id="projectId" name="clientProject.projectId" value="${projectId}" />
				...
				<table>
					...
					<tr>
						...
						<td class="content"><input id="loanHopeMoney"
							...
							max="9999999.99" name="applyPersonBasic.loanHopeMoney"
					...
					<tr>
						...
						<td class="content"><radio:radio biztypekey="1023"
								id="loanPurpose" name="applyPersonBasic.loanPurpose"></radio:radio>
					...
					<tr>
						...
						<td class="content"><radio:radio biztypekey="1022"
								id="infoFrom" name="applyPersonBasic.infoFrom"></radio:radio> <label
							class="del_mandatory">*</label></td>
					</tr>
					<tr>
						<!-- 贷款产品 -->
						...
						<table class="col3">
							...
							<tr>
								...
								<td class="content"><input id="personBasic.birthday"
									...
									name="personBasic.birthday"
									value="${personBasic.birthdayAlias}" /> <label
									class="del_mandatory">&nbsp;*</label></td>
								<!-- 性别  personBasic.sex-->
								...
								<td class="content"><bizoption:bizoption biztypekey="1006"
										...
										mandatory="true" selected="${personBasic.sex}" /> <label
									class="del_mandatory">&nbsp;*</label></td>
							</tr>
							<tr>
								...
								<td class="content"><input id="mobilePhone"
									...
									checkmaster="validatemobile" /> <label class="del_mandatory">&nbsp;*</label></td>
							...
							<tr>
								...
								<td class="content"><bizoption:bizoption biztypekey="1008"
										...
										isChoose="true" mandatory="true"
										selected="${personBasic.educationLevel}" /> <label
									class="del_mandatory">&nbsp;*</label></td>
								...
								<td class="content"><bizoption:bizoption biztypekey="1009"
										...
										isChoose="true" mandatory="true"
										selected="${personBasic.maritalStatus}" /> <label
									class="del_mandatory">&nbsp;*</label></td>
							</tr>
							<tr>
								<!-- 客户户籍所在地 -->
							...
							<tr>
								...
								<td class="content"><bizoption:bizoption biztypekey="1010"
										...
										mandatory="true" selected="${personBasic.houseCondition}" />
									<label class="del_mandatory">&nbsp;*</label></td>
								...
								<td class="content"><input id="houseBegin" loxiaType="date"
									trim="true" mandatory="true" name="personBasic.houseBegin"
							...
							<tr>
								...
								<td class="content"><input id="houseExpend"
									loxiaType="number" name="personBasic.houseExpend" trim="true"
									decimal="2" value="${personBasic.houseExpend}" /></td>
							</tr>
							<tr>
								...
								<td class="label"><fmt:message key="label.applyDetail.im"
										bundle="${lang}" /></td>
								<td width="150"><input id="im" loxiaType="input"
							...
							<tr>
								...
								<td width="150"><input id="socialSecurity"
						...
						<table class="col3">
							...
							<tr>
								...
								<td class="content"><input id="incomeAvgMonth"
									loxiaType="number" decimal="2"
									name="personBasic.incomeAvgMonth"
					...
					<div class="content_middle">
						<table class="col3">
							...
							<tr>
								...
								<td><input id="privateSiteEnd" loxiaType="date"
							...
							<tr>
								...
								<td><input id="privateregisterNo" loxiaType="input"
							...
							<tr>
								...
								<td><bizoption:bizoption biztypekey="1019" id="privateLoan"
					...
					<table class="col3">
						<tr>
							...
							<!--  
									...
									<td class="content"><input id="clientProject.salerTeam"
										loxiaType="number" name="clientProject.salerTeam" /></td>
								    -->
							<td class="label"></td>
							<td class="content"></td>
						</tr>
						<tr>
							...
							<td class="content"><userDepartment:userDepartment
									...
									name="clientProject.saleraCode" isChoose="true"
									mandatory="true" /> <label class="del_mandatory">*</label></td>

							<td class="label">客户经理B：</td>
							<td class="content"><userDepartment:userDepartment
									bizHall="${bizHall}" id="salerbCode"
									selected="${personBasic.salerbCode}"
									name="clientProject.salerbCode" isChoose="true" /></td>
						</tr>
					</table>
					<div class="content_middle">
