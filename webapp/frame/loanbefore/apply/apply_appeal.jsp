...
<script type="text/javascript"
	src="<c:url value='/scripts/frame/loanbefore/apply/apply_appeal.js'/>"></script>
<style type="text/css">
.label {
	text-align: left;
}
	...
	<form id="applyAppeal" method="post">
		...
		<table>
			<tr>
				...
				<td width="450"><bizoptionname:showname biztypekey="1033" name="checkPerson" property="checkStatus" /> 
				<input id="checkId" name="checkId" value="${checkPerson.checkId}" type="hidden" /> 
		...
		<table>
			<tr>
				...
				<td align="left"><input id="checkCause" name="checkCause"
					...
					value="${checkPerson.operReason}" /></td>
				<td class="label">原因备注</td>
				<td><input id="checkResult" name="checkResult"
					loxiaType="input" trim="true" readonly="true"
					value="${checkPerson.operReasonRemark}" /></td>
			</tr>
		</table>
