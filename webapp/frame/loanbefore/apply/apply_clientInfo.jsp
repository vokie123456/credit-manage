		...
		<table class="col3">
			...
			<tr>
				...
				<td class="content"><bizoption:bizoption biztypekey="1006"
						id="sex" name="personBasic.sex" isChoose="true" mandatory="true"
						selected="${personBasic.sex}" /> <label class="del_mandatory">&nbsp;*</label>
				</td>
			</tr>
			<tr>
					...
					<table class="col3">
						<tr>
							...
							<td class="content"><input id="town2" name="address2.town"
								loxiaType="input" trim="true" mandatory="true"
								value="${personBasic.town2}" /><label class="del_mandatory">&nbsp;*</label></td>
						</tr>
					</table>
				</td>
			</tr>
			<tr>
				...
				<td class="content"><bizoption:bizoption biztypekey="1010"
						...
						isChoose="true" mandatory="true"
						selected="${personBasic.houseCondition}" /> <label
					class="del_mandatory">&nbsp;*</label></td>
			...
			<tr>
				...
				<td class="content"><bizoption:bizoption biztypekey="1011"
						...
						mandatory="true" selected="${personBasic.houseStatus}" /> <label
					class="del_mandatory">&nbsp;*</label></td>
					...
					<table>
						<tr>
							...
							<td class="content"><input id="town3" name="address3.town"
								loxiaType="input" trim="true" value="${personBasic.town3}" /></td>
						</tr>
					</table>
				</td>
			</tr>
		...
		<table class="col3">
			...
			<tr>
				...
				<td class="content"><input id="incomeHouseRent"
					loxiaType="number" decimal="2" name="personBasic.incomeHouseRent"
					value="${personBasic.incomeHouseRent}" /></td>
				<!-- 其他收入 personBasic.incomeOther -->
				<td class="label"><fmt:message
						key="label.applyDetail.incomeOther" bundle="${lang}" /></td>
				<td class="content"><input id="incomeOther" loxiaType="number"
					decimal="2" name="personBasic.incomeOther"
	...
	<div class="content_middle">
		<table class="col3">
			...
			<tr>
				...
				<td class="content"><input id="privateAnnualCheck"
					loxiaType="input" name="personBasic.privateAnnualCheck"
					value="${personBasic.privateAnnualCheck}" /></td>
			</tr>
			<tr>
				<!-- 月均盈利/亏损额  personBasic.privateProfitMonth -->
