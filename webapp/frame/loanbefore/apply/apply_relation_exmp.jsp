...
<table class="col3">
	<tr>
		...
		<td class="content"><bizselect:bizselect biztypekey="1020"
				...
				name="resonRelations[${count}].relationType" 
		...
		<td class="content"><input id="relationobjName" loxiaType="input"
			trim="true" 
			name="resonRelations[${count}].relationobjName" /></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="content"><input id="incomeWorkunit" loxiaType="input"
	...
	<tr>
		...
		<td class="content"><input id="resonRelations[${count}].email"
			loxiaType="input" name="resonRelations[${count}].email" /></td>
	</tr>
	<tr>
