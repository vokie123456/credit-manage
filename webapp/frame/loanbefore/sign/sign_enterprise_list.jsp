...
<title><fmt:message key="label.enterprise.sign.query"
		bundle="${lang}" /></title>
<script type="text/javascript"
	src="<c:url value='/scripts/frame/loanbefore/sign/sign_enterprise_list.js'/>"></script>
<script type="text/javascript"
	...
	<div id="formdetail">
		...
		<form id="signListForm" method="post">
			<table>
				...
				<tr>
				    <td class="label"><fmt:message
							key="label.sign.contractId" bundle="${lang}" /></td>
					<td width="150"><input name="contractId" loxiaType="input"
						trim="true" /></td>
				
				<!--  审批金额 -->
					<td class="label"><fmt:message key="label.audit.taskquery.money_check" bundle="${lang}" /></td>
				...
				<!-- 调查人员 -->
					<td class="label"><fmt:message
							key="label.sign.signerCode" bundle="${lang}" /></td>
					<td><userDepartment:userDepartment bizHall="${bizHall}" id="signerCode" name="signerCode" isChoose="true"/></td>
				 <td class="label"><fmt:message
							key="label.sign.signDate" bundle="${lang}" /></td>
					<td><input id="signEndBegin" loxiaType="date" name="signEndBegin" /></td>
				...
				<tr>
					...
					<td width="150"><bizoption:bizoption name="signStatus" biztypekey="1036" isChoose="true" /></td>				
					<td class="label"><fmt:message
							key="label.apply.clientproject.dataRole" bundle="${lang}" /></td>
					<td width="150"><bizoption:bizoption biztypekey="rolelevel" id="roleLevel" name="roleLevel" /></td>
					<td class="label"></td>
					<td></td>
