...
<form id="frm-userRole" onsubmit="return false">
	<input type="hidden" name="checkType" value="${audit.checkType }" />
</form>
...
$j(document).ready(function(){
	...
	// 初始化 roleUser 表
 	$j("#tbl-userlist").jqGrid({
			...
			colNames: ["", i18("USER_CODE"),i18("USER_NAME"),i18("EMP_CODE"),i18("EMP_NAME"),i18("ORG_CODE"),i18("ORG_NAME"),i18("ROLE_CODE"),i18("ROLE_NAME")],
			
			// name根据返回 entity或者 vo属性对应
			colModel: [//{name: "rowNumber", width: 0,align: "center", resizable: true,hidden:true},
			           {name: "userId", width: 10,align: "center", resizable: true,hidden:true},
			           {name: "userCode", index: "userCode", width: 80,align: "center", resizable: true},
			           ...
			           {name: "empName", index: "empName", width: 70, align: "center", resizable: true,hidden:true},		         
 	...
 	$j('#dialog-chgrole').dialog({autoOpen: false,width:500,
		title:   i18("RESULT_DATA_TITLE"),  
         ...
         "confirm": function() {
      	   ...
      	   $j("#txtChecker").val(data["userName"]);
      	   
	       if ($j("#checkerCode") != undefined)
	      	   $j("#checkerCode").val(data["userId"]);
