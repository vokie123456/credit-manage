...
<script type="text/javascript"
	src="<c:url value='/scripts/frame/loanbefore/companyinves/company_inves_list.js'/>"></script>
<script type="text/javascript"
			...
			<table>
				...
				<tr>
					...
					<td><userDepartment:userDepartment bizHall="${bizHall}"
							id="investigatorCode" name="investigatorCode" isChoose="true" /></td>
					<!-- 调查提交时间区间 -->
					<td class="label"><fmt:message
							key="label.research.research_commit_date" bundle="${lang}" /></td>
					<td><input id="investigationComBeg" loxiaType="date"
						name="investigationComBeg" /></td>
					<td align="center" class="label" checkmaster="setMaxDate"><fmt:message
							key="label.credit.list.query.to" bundle="${lang}" /></td>
					<td><input id="investigationComEnd" loxiaType="date"
						name="investigationComEnd" /></td>
					<td colspan="2"></td>
				</tr>
				<tr>
				</tr>
				<tr>
					...
					<td><bizoption:bizoption biztypekey="1032"
							id="investigationStatus" name="investigationStatus"
							isChoose="true" /></td>
					<td class="label"><fmt:message
