...
<script type="text/javascript"
	src="<c:url value='/scripts/frame/loanbefore/checktask/check_enterprise_detail.js'/>"></script>
<style type="text/css">
.hidden {
	display: none;
	visibility: hidden;
			...
			<div id="form1">
				...
				<table id="tbl-checkdetail" class="col3">
					...
					<tr>
						...
						<td colspan="3" id="tabSpecialName"></td>
					</tr>
					<tr>
			...
			<table class="col3">
				...
				<tr>
					<td class="label"><fmt:message key="label.memo.oper.remark"
							bundle="${lang}" /></td>
					<td class="content" id="tabOperRemark"></td>
					<td colspan="2"></td>
				</tr>
			</table>
