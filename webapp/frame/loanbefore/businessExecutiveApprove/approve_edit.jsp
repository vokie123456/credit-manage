...
<script type="text/javascript"
	src="<c:url value='/scripts/frame/loanbefore/businessExecutiveApprove/approve_edit.js'/>"></script>
</head>
<body contextpath="<%=request.getContextPath()%>">
	<div id="div_out"
		...
		<ul
			...
			<li class="ui-state-default ui-corner-top"><a href="#div-2">个人征信</a></li>
