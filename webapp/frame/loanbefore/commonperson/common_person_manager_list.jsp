...
<script type="text/javascript"
	src="<c:url value='/scripts/frame/loanbefore/commonperson/common_person_manager_list.js'/>"></script>
<script type="text/javascript"
		...
		<form id="clientProjectQueryForm">
			<table>
				...
				<tr>
					...
					<td>
					<bizoption:bizoption name="cardType" biztypekey="1007,1102" isChoose="true"/>
					</td>
