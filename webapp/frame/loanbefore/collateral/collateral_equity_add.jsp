...
<script type="text/javascript"
	src="<c:url value='/scripts/frame/loanbefore/collateral/collateral_equity_add.js'/>"></script>
</head>
...
<body contextpath="<%=request.getContextPath()%>">
	...
	<div id="otherCollateralDetailDiv">
		<div class="divBgColor">股权评估</div>

		<form id="otherCollEditForm" method="post">
			<input type="hidden" id="equity_projectId" name="equityProjectId"
				value="${projectId}" /> <input type="hidden" name="collateralId"
				value="${equity.collateralId }" />
			...
			<table class="col3">
				...
				<tr>
					...
					<td class="content"><input name="collateralName"
						value="${equity.collateralName}" loxiaType="input" trim="true" /></td>
				</tr>
				<tr>
					<!-- 贷款金额 -->
					<td class="label">质押贷款总额(万元)：</td>
					<td class="content"><input name="loanMoney"
						value="${equity.loanMoney}" loxiaType="money" trim="true" /></td>

					<!-- 贷款余额  -->
					<td class="label">质押贷款余额(万元)：</td>
					<td class="content"><input name="loanBalance"
						value="${equity.loanBalance}" loxiaType="money" /></td>
				</tr>
				<tr>
					<!-- 购买日期 -->
					<td class="label"><fmt:message
					...
					<td class="content"><input name="buyDate"
						value="${equity.buyDate}" loxiaType="date" trim="true" /></td>

					<!-- 购买金额-->
					<td class="label"><fmt:message
							key="label.assessCar.edit.collateral.buyMoney" bundle="${lang}" /></td>
					<td class="content"><input name="buyMoney"
						value="${equity.buyMoney}" loxiaType="money" trim="true" /></td>
				</tr>
				<tr>
					<td class="label">&nbsp;</td>
					<td class="content"></td>
				...
				<tr>
					...
					<td class="content"><input name="collateralRate" id="collateralRate"
						value="${equity.collateralRate}" loxiaType="number" trim="true"
						decimal="2" /></td>
				</tr>
				<tr>
					<!-- 抵押/过户时间 -->
					...
					<td class="content"><input name="collateralTime" id="collateralTime"
						value="<fmt:formatDate value="${equity.collateralTime}" pattern="yyyy-MM-dd"/>" loxiaType="date" checkmaster="setMinDate"/></td>
					<td class="label">质押结束时间：</td>
					<td class="content"><input name="collateralTimeEnd" id="collateralTimeEnd"
						value="<fmt:formatDate value="${equity.collateralTimeEnd}" pattern="yyyy-MM-dd"/>" loxiaType="date" checkmaster="setMaxDate"/></td>
				</tr>
				<tr>
					<!-- 评估人员 -->
					<td class="label">评估机构：</td>
					<td class="content"><input name="assessName"
						value="${equity.assessName}" loxiaType="input" trim="true" /></td>

					<!-- 评估时间 -->
					<td class="label">评估时间：</td>
					<td class="content"><input name="assessTime"
						value="${equity.assessTime}" loxiaType="date" /></td>
				</tr>
				<tr>
					<!-- 评估总价 -->
					<td class="label">评估总价(万元)：</td>
					<td class="content"><input name="assessTotalprice"
						value="${equity.assessTotalprice}" loxiaType="money"
						trim="true" /></td>
					<!-- 资产状态 -->
					<td class="label">资产状态：</td>
					<td class="content"><bizoption:bizoption biztypekey="1081"
							name="collateralStatus" isChoose="false"
							selected="${equity.collateralStatus}" /></td>
				</tr>
				<tr>
					<!-- 备注 -->
					<td class="label"><fmt:message
					...
					<td colspan="3"><textarea rows="6" style="width: 94%;" name="remark"
							loxiaType="input">${equity.remark}</textarea></td>
				</tr>
			</table>
			<!-- 共同所有人 -->
