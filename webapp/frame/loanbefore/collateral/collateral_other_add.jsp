...
<script type="text/javascript"
	src="<c:url value='/scripts/frame/loanbefore/collateral/collateral_other_add.js'/>"></script>
</head>
			...
			<table class="col3">
				...
				<tr>
					...
					<td class="content"><input name="collateralName"
						value="${other.collateralName}" loxiaType="input" trim="true" /></td>
				</tr>
				<tr>
					<!-- 贷款金额 -->
					<td class="label">抵押贷款总额(万元)：</td>
					<td class="content"><input name="loanMoney"
						value="${other.loanMoney}" loxiaType="money" trim="true" /></td>

					<!-- 贷款余额  -->
					<td class="label">抵押贷款余额(万元)：</td>
					<td class="content"><input name="loanBalance"
						value="${other.loanBalance}" loxiaType="money" /></td>
				</tr>
				<tr>
					<!-- 购买日期 -->
					<td class="label"><fmt:message
					...
					<td class="content"><input name="buyDate"
						value="${other.buyDate}" loxiaType="date" trim="true" /></td>

					<!-- 购买金额-->
					<td class="label"><fmt:message
							key="label.assessCar.edit.collateral.buyMoney" bundle="${lang}" /></td>
					<td class="content"><input name="buyMoney"
						value="${other.buyMoney}" loxiaType="money" trim="true" /></td>
				</tr>
				<tr>
					<td class="label">&nbsp;</td>
					<td class="content"></td>
				...
				<tr>
					...
					<td class="content"><input name="collateralRate" id="collateralRate"
						value="${other.collateralRate}" loxiaType="number" trim="true"
						decimal="2" /></td>
				</tr>
				<tr>
					<!-- 抵押/过户时间 -->
				...
				<tr>
					...
					<td colspan="3"><textarea rows="6" style="width: 94%;" name="remark"
							loxiaType="input">${other.remark}</textarea></td>
				</tr>
			</table>
			<!-- 共同所有人 -->
