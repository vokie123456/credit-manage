...
<script type="text/javascript"
	src="<c:url value='/scripts/frame/loanbefore/collateral/collateral_other_detail.js'/>"></script>
</head>
	...
	<div id="otherCollateralDetailDiv">
		...
		<table class="textalignCenter tabcustomPeo" cellpadding="0"
			...
			<tr>
				...
				<td class="content"><fmt:formatDate value="${other.collateralTime}" pattern="yyyy-MM-dd"/></td>
				<td class="label BgColor" >抵押结束时间：</td>
				<td class="content tabBorderRight"><fmt:formatDate value="${other.collateralTimeEnd}" pattern="yyyy-MM-dd"/></td>
			</tr>
			<tr>
				<!-- 评估人员 -->
