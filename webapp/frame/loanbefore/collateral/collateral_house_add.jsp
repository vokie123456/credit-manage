...
<script type="text/javascript"
	src="<c:url value='/scripts/frame/loanbefore/collateral/collateral_house_add.js'/>"></script>
</head>
		...
		<form id="assessHouseEditForm" method="post">
			...
			<table class="col3">
				...
				<tr>
					...
					<td><input name="itCardNo" loxiaType="input" trim="true"
						value="${house.itCardNo }" /></td>
					<!-- 公证号-->
					<td class="label">公证号：</td>
					<td><input name="notaryNo" loxiaType="input" trim="true"
						value="${house.notaryNo }" /></td>
				</tr>
				<tr>
					<!-- 贷款金额 -->
					<td class="label">抵押贷款总额(万元)：</td>
					<td class="content"><input name="loanMoney"
						value="${house.loanMoney}" loxiaType="money" trim="true" /></td>

					<!-- 贷款余额  -->
					<td class="label">抵押贷款余额(万元)：</td>
					<td class="content"><input name="loanBalance"
						value="${house.loanBalance}" loxiaType="money" /></td>
				</tr>
				<tr>
					<!-- 购买日期 -->
					...
					<td class="content"><input name="buyDate"
						value="${house.buyDate}" loxiaType="date" trim="true" /></td>

					<!-- 购买金额-->
					<td class="label"><fmt:message
							key="label.assessCar.edit.collateral.buyMoney" bundle="${lang}" /></td>
					<td class="content"><input name="buyMoney"
						value="${house.buyMoney}" loxiaType="money" trim="true" /></td>
				</tr>
				<tr>
					<!-- 土地证号-->
					<td class="label"><fmt:message
				...
				<tr>
					...
					<td class="content"><input name="areaBuilding"
						value="${house.areaBuilding}" loxiaType="number" trim="true"
						decimal="2" /></td>
				</tr>
				<tr>
					<!-- 家访租约情况 -->
				...
				<tr>
					...
					<td class="content"><input name="primarycolAmount"
						value="${house.primarycolAmount}" loxiaType="money" trim="true" /></td>
				</tr>
				<tr>
					<td class="label">本次抵押金额(万元)：</td>
					<td class="content"><input name="thisAmount" id="thisAmount" onchange="countRate()"
						value="${house.thisAmount}" loxiaType="money" trim="true"
						/></td>
					<!-- 押品抵押率  -->
					<td class="label"><fmt:message
					...
					<td class="content"><input name="collateralRate" id="collateralRate"
						value="${house.collateralRate}" loxiaType="number" trim="true"
						decimal="2" /></td>
				</tr>
				<tr>
					<!-- 抵押/过户时间 -->
					...
					<td class="content"><input name="collateralTime" id="collateralTime"
						value="<fmt:formatDate value="${house.collateralTime}" pattern="yyyy-MM-dd"/>" loxiaType="date" checkmaster="setMinDate"/></td>
					<td class="label">抵押结束时间：</td>
					<td class="content"><input name="collateralTimeEnd" id="collateralTimeEnd"
						value="<fmt:formatDate value="${house.collateralTimeEnd}" pattern="yyyy-MM-dd"/>" loxiaType="date" checkmaster="setMaxDate"/></td>
				</tr>
				...
				<tr>
					...
					<td class="content"><input name="assessName"
						value="${house.assessName}" loxiaType="input" trim="true" /></td>
				...
				<tr>
					...
					<td class="content"><input name="assessTotalprice"
						value="${house.assessTotalprice}" loxiaType="money"
						trim="true" /></td>
					<!-- 资产状态 -->
				...
				<tr>
					...
					<td colspan="3"><textarea rows="6" style="width: 94%;" name="remark"
							loxiaType="input">${house.remark}</textarea></td>
