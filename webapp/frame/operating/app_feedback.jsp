...
<script type="text/javascript"
	src="<c:url value='/scripts/frame/operating/app_feedback.js?v=1.0.3'/>"></script>
<script type="text/javascript"
...
<body contextpath="<%=request.getContextPath()%>">
	...
	<div class="reply">
	   <a href="javascript:;" id="noReply" class="active">待回复</a>
	   <a href="javascript:;" id="alreadyReply">已回复</a>
	</div>
	<form id="lendListForm" method="post">
		<table>
			<tr>
				...
				<td width="150">
					<input id="" name="beginCreateTime" loxiaType="date" trim="true" />到
				</td>
				<td width="150">	
					<input id="" name="endCreateTime" loxiaType="date" trim="true" />
				</td>
		...
		<div class="buttonlist buttonDivWidth">
			...
			<!-- <table>
				<tr>
					<td><input class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only ui-state-hover" type="button" value="未回复" id="noReply"/></td>
					<td><input type="button" value="已回复" id="alreadyReply"/></td>
				</tr>
			</table> -->
			<%-- <a  href="<%=request.getContextPath()%>/frame/operating/app_feedback.jsp" id="noReply" > 
				未回复
			</a>
