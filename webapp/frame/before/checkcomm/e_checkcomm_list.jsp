...
<title>业务主管审批列表</title>
<script type="text/javascript"
	src="<c:url value='/scripts/frame/before/checkcomm/e_checkcomm_list.js'/>"></script>
<script type="text/javascript"
...
<body contextpath="<%=request.getContextPath()%>">
	<div id="formdetail">
		...
		<form id="eCheckCommListForm" method="post">
			<table>
				<tr>
					<!-- 项目编号-->
				...
				<tr>
					...
					<td align="center" class="label"><fmt:message
							key="label.credit.list.query.to" bundle="${lang}" /></td>
					<td><input id="submitEnd" loxiaType="date" name="submitEnd" /></td>
				</tr>
				<tr>
					<!-- 贷审会召开时间 -->
					<td class="label">贷审会召开时间：</td>
					<td><input id="checkDateBegin" loxiaType="date"
						name="checkDateBegin" /></td>
					<td align="center" class="label"><fmt:message
							key="label.credit.list.query.to" bundle="${lang}" /></td>
					<td><input id="checkDateEnd" loxiaType="date"
						name="checkDateEnd" /></td>
				</tr>
				<tr>
					<!-- 申请状态 -->
					...
					<td><input id="checkNo" name="checkNo" loxiaType="input"
						trim="true" /></td>
				</tr>
			</table>
		</form>
		...
		<table id="tbl-eCheckCommList"></table>
		<div id="pager"></div>
	</div>
</body>
</html>
