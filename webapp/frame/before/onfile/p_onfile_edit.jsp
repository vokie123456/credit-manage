...
<script type="text/javascript" src="<c:url value='/scripts/frame/before/onfile/p_onfile_edit.js'/>"></script>
	<script type="text/javascript"
	src="<c:url value='/scripts/frame/before/common/prev_opinion.js'/>"></script>
<form id="onfileForm" method="post">
...
<!-- 	上一节点操作意见 -->
	...
	<input type="button" class="confirm" id="loadFiles"  value="归档文件"  loxiaType="button" />
