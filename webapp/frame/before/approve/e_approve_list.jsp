...
<script type="text/javascript"
	src="<c:url value='/scripts/frame/before/approve/e_approve_list.js'/>"></script>
<script type="text/javascript"
...
<body contextpath="<%=request.getContextPath()%>">
	<div id="formdetail">
		...
		<form id="eApproveListForm" method="post">
			<table>
				<tr>
					<!-- 项目编号-->
				...
				<tr>
				<!-- 申请状态 -->
					<td class="label">业务主管审批状态</td>
					<td width="150"><bizoption:bizoption biztypekey="1046"
							name="reviewstatus" isChoose="true" /></td>
				</tr>
			</table>
		</form>
		...
		<table id="tbl-eApproveList"></table>
		<div id="pager"></div>
	</div>
</body>
</html>
