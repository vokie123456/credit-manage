...
<script type="text/javascript"
	src="<c:url value='/scripts/frame/before/signcontract/p_signcontract_list.js'/>"></script>
<script type="text/javascript"
...
<body contextpath="<%=request.getContextPath()%>">
	<div id="formdetail">
		<div class="divBgColor">个人签约信息查询</div>
		<form id="pSigncontractListForm" method="post">
			<table>
				<tr>
				...
				<tr>
					...
					<td><user:user userId="${userId }" roleCode="0101"
			...
			<table id="tbl-pSigncontractList"></table>
			<div id="pager"></div>
		</form>
	</div>
</body>
