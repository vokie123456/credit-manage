...
<script type="text/javascript"
	src="<c:url value='/scripts/frame/before/signcontract/e_signcontract_edit.js'/>"></script>
<script type="text/javascript"
...
<form id="eSigncontractForm" method="post">
	...
	<input id="compCode" type="hidden" value="${compCode}" />
		<table class="col3">
			...
			<tr>
				...
				<td class="content"><input id="bankCardRepay" loxiaType="input"
					name="bankCardRepay" value="${clientBasic.openCardNoRepay}" /></td>
			</tr>
			<tr>
