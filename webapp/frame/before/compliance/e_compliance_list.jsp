...
<script type="text/javascript"
	src="<c:url value='/scripts/frame/before/compliance/e_compliance_list.js'/>"></script>
<script type="text/javascript"
...
<body contextpath="<%=request.getContextPath()%>">
	<div id="formdetail">
		...
		<form id="eComplianceListForm" method="post">
			<table>
				<tr>
					<!-- 项目编号-->
				...
				<tr>
				<!-- 申请状态 -->
					<td class="label">合规状态：</td>
					<td width="150"><bizoption:bizoption biztypekey="1146"
							name="regularstatus" isChoose="true" /></td>
				</tr>
			</table>
		</form>
		...
		<table id="tbl-eComplianceList"></table>
		<div id="pager"></div>
	</div>
</body>
</html>
