...
<head>
  ...
  <script type="text/javascript"
          src="<c:url value='/scripts/frame/before/contract/contract_manager_list.js'/>"></script>
  <script type="text/javascript"
...
<div>
  <form id="clientProjectQueryForm" method="post">
    <table>
      <tr>
      ...
      <tr>
        ...
        <td width="150"><user:user bizHall="${bizHalls }" roleCode="0101,0102" userId="${userId }"
                                   compCode="${compCode }"
